...
//            new PopulateDbAsync(INSTANCE).execute();
            ...
            String[] words = {"dolphin", "crocodile", "cobra", "check", "check", "nigga", "boy", "ziyech", "checki", "zoom", "zoom2", "dolphin", "crocodile", "cobra", "check", "check", "nigga", "boy", "ziyech", "checki", "zoom", "zoom2"};
